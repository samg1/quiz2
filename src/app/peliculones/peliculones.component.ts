...
@Component({
  selector: 'app-peliculones',
  templateUrl: './peliculones.component.html',
  styleUrls: ['./peliculones.component.scss']
})
export class PeliculonesComponent implements OnInit {
  ...
  actualpeli: string;
  actualpeli2 = this.peliculas[0];

  // tslint:disable-next-line: adjacent-overload-signatures
  selected() {
    this.actualpeli2 = this.peliculas.find((c) => c.Title === this.actualpeli);
    console.log(this.actualpeli2);

  }

  cambiar() {
    const pene = (document.getElementById('pelis') as HTMLInputElement).value;
    this.actualpeli = pene;
    console.log(this.actualpeli);
  }
